...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      supabaseUrl: 'https://miwxbwybxzauojqbsefd.supabase.co',
      supabaseAnonKey: 'sb_publishable_BZf4aGtXXdBo3cyfAfZlUQ_Iv_Q2Tb2',
    },
  },
      ...
      meta: [
        {
          name: 'description',
          content:
            'Private payroll and invoicing on Solana with confidential transfers and zero-knowledge receipts.',
        },
